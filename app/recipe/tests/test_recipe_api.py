...
def sample_tag(user, name="Main Course"):
    """ Create and returna a sample tag """
    return Tag.objects.create(user=user, name=name)


def sample_ingredient(user, name="Cinnamon", origin="USA"):
    """ Create and returna a sample ingredient """
    return Ingredient.objects.create(user=user, name=name, origin=origin)
...
class PrivateRecipeApiTests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user("test@jourec.com", "testpass")
    ...
    def test_recipes_limited_to_user(self):
        ...
        user2 = get_user_model().objects.create_user("other@joeurc.com", "password12")
    ...
    def test_create_recipe_with_ingredients(self):
        """ Test creating recipe with tags """
        ingredient1 = sample_ingredient(user=self.user, name="Avocado", origin="Peru")
...
class RecipeImageUploadTests(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user("joeu@aol.com", "testpass")
    ...
    def test_filer_recipes_by_tags(self):
        ...
        tag1 = sample_tag(user=self.user, name="Vegan")
        tag2 = sample_tag(user=self.user, name="Chicken")
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        res = self.client.get(
            RECIPES_URL, {"ingredients": f"{ingredient2.id},{ingredient1.id}"}
        )
